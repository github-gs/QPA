...
#'
#' @usage pathway_vectorize(nmerge_tab,condition,group1,group2,pathway_info)
#'
...
#'
#'
pathway_vectorize<-function(nmerge_tab,condition,group1,group2,pathway_info){
